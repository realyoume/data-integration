      ...
      <div class="form">
        <el-form :model="userInfo" :label-width="'100px'">
          ...
          <el-form-item label="密码：">
            <el-input v-model="userInfo.password" placeholder="请输入密码" type="password" @keyup.native.enter="loginThis()"></el-input>
          </el-form-item>
        </el-form>
      </div>
      <div class="confirm">
        ...
        if (_res.code === '00000') {
          ...
          if (token == null) {
            ...
            auth(config).then(res2 => {
              // console.log(res2);
              sessionStorage.setItem("name", res2.result.username);
              sessionStorage.setItem("role", res2.result.root);
