...
import {getOtherCourse, getMyCourse, chooseOtherCourse, unchooseCourse} from "@/network/course";
export default {
  name: 'OtherCourse',
  components: {
    Layout,
  ...
  methods: {
    ...
    choose(id){
      ...
      chooseOtherCourse(config).then(_res => {
        if(_res.code === '00000'){
          this.$message({
            type: 'success',
            message: '选课成功'
